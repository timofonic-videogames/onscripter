...
export LDFLAGS="-Wl,-syslibroot,/Developer/SDKs/MacOSX10.3.9.sdk -Wl,-framework,OpenGL"
...
export OTHERCONFIG="--build=powerpc-apple-darwin7.9.0"
./configure --with-internal-libs
make || exit
mv onscripter onscripter.ppc
make distclean &>/dev/null

export LDFLAGS="-Wl,-syslibroot,/Developer/SDKs/MacOSX10.4u.sdk -Wl,-framework,OpenGL"
export CCARGS="-arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk"
export CC="gcc $CCARGS"
export CXX="g++ $CCARGS"
export OTHERCONFIG="--build=i386-apple-darwin8.11.1"
./configure --with-internal-libs
make || exit
